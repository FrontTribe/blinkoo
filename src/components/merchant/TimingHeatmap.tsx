    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-heading text-lg font-semibold text-text-primary">By Hour of Day</h3>
        </div>
        <div className="grid grid-cols-6 md:grid-cols-12 gap-2">
          {hourlyData.map(({ hour, count }) => (
            ...
            >
              ...
              {coldHours.includes(hour) && <div className="text-xs mt-1 opacity-75">Cold</div>}
            </div>
          ))}
        </div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-heading text-lg font-semibold text-text-primary">By Day of Week</h3>
        </div>
        <div className="grid grid-cols-7 gap-2">
          {dailyData.map(({ day, dayName, count }) => (
            <div key={day} className={`text-center p-3 rounded border ${getIntensity(count)}`}>
              ...
              <div className="text-xs mt-1">claims</div>
            </div>
          ))}
        </div>
      </div>
